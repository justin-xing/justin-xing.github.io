...
import california from '../../../assets/home-images/california.jpg';
import jeju from '../../../assets/home-images/jeju.jpg';
import japan from '../../../assets/home-images/japan.jpg';
...
const AnimatedBackground = () => {
    ...
    return (
        <div className={classes.wrapper}>
            ...
            <img alt='' className={`${classes.imageThree} ${index === 2 || index === 1 ? classes.currentImage : ''}`} src={japan} key={2}/>
            <img alt='' className={`${classes.imageFour} ${index === 3 || index === 2 ? classes.currentImage : ''}`} src={california} key={3}/>
        </div>
    )
}
